...
import ImageSolar from "../../Assets/ImageSolar.png";
  ...
  return (
    <header ref={ref} className="mx-auto relative">
      <Helmet>
        ...
        <meta
          name="description"
          content="Viverra viverra nibh enim et aliquam, enim. Tempor, sit mus viverra orci dui consequat turpis scelerisque."
        />
      </Helmet>
        ...
        >
          ...
          <figure className="mt-8 lg:mt-28">
            ...
            <figcaption className="flex flex-wrap gap-2 cursor-pointer mt-7">
              <LazyLoadImage src={User1} alt="Imagem de Rwanda Melflor" />
              <p className="font-normal text-lg text-[#0F172A] leading-[28.8px]">
                Rwanda Melflor
                <br />
                <span className="font-normal text-base text-[#475569] leading-[22.4px]">
                  zerowaste.com
                </span>
              </p>
            </figcaption>
