...
export const Title = ({ text, className = '' }) => {
  return (
    <h1 className={`text-[32px] leading-[35.2px] font-bold mt-4 mb-6 
...
export const Description = ({ text, className = '' }) => {
  return (
    <p className={`text-base leading-[22.4px] font-normal md:text-xl md:leading-9 md:font-normal lg:text-xl lg:leading-9 lg:font-normal ${className}`}>
      {text}
    </p>
  );
};
...
export const SubTitle = ({ text, className = '' }) => {
  return (
    <p className={`text-base leading-[17.6px] font-medium mt-16 
...
export const H2 = ({ text, className = '' }) => {
  return (
    <h2 className={`text-xl leading-[22px] font-medium max-w-[147.5px]
...
export const P = ({ text, className = '' }) => {
  return (
    <p className={`text-base leading-[22.4px] font-normal max-w-[147.5px] text-center 
